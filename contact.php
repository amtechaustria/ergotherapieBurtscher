             ...
             <!--<a href="datenschutzerklaerung.html"target="_blank"><span>Datenschutzerklärung</span></a> &nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <div>
                ...
                <div style="white-space: nowrap; text-align: center; width: 400px; padding: 6px 0;">
                   <a id="largeMapLink" target="_blank" href="https://www.bing.com/maps?cp=47.39056109528359~11.772584169311507&amp;sty=r&amp;lvl=18&amp;FORM=MBEDLD">Größere Karte anzeigen</a> &nbsp; | &nbsp;
    ...
    <!-- <div class="mt-5 block-cta-1 primary-overlay" style="background-image: url('images/hero_bg_2.jpg')">
      <div class="container">
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-lg-4">
            <p class="mb-0"><a href="map.html"target="_blank" class="btn btn-outline-white text-white btn-md btn-pill px-5 font-weight-bold btn-block">Karte öffnen</a></p>
          </div>
        </div>
      </div>
    </div> -->
