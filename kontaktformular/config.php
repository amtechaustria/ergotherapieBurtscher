...
$empfaenger = "info@ergotherapie-burtscher.at";  // Bitte tragen Sie hier Ihre E-Mail Adresse ein. (zwischen den Anführungszeichen)

$ihrname = "Ergotherapie Burtscher";  // Bitte tragen Sie hier Ihren Namen ein. (zwischen den Anführungszeichen) Dieser erscheint als Absender in der Danke Mail.

$cfg['DATENSCHUTZ_ERKLAERUNG'] = 1;  //  0 = Ohne Datenschutzerklärung    1 = Mit Datenschutzerklärung

$datenschutzerklaerung = "https://www.ergotherapie-burtscher.at/datenschutzerklaerung.html";  //  Pfad zur Datenschutzerklärung. "datenschutz.php" kann durch einen Link/URL ersetzt werden. (muss mit "http://www." anfangen!)
...
// Funktionsweise des Bad Word Filters:https://www.ergotherapie-burtscher.at/datenschutzerklaerung.html
...
$cfg['Badwordfields'] = 'anrede, titel, vorname, name, firma, telefon, email, betreff, nachricht';  //   Die Namen der Felder, die bei dem Bad Word Filter geprüft werden sollen - Groß- und Kleinschreibung beachten!
...
$smtp['host'] = '315.hostserv.eu'; // Der Host, unter welchem der SMTP Server erreichbar ist. (bspw. smtp.gmail.com)
   
$smtp['user'] = 'kontaktformular@ergotherapie-burtscher.at'; // Der Benutzername, mit welchem Sie sich bei Ihrem SMTP Server authentifizieren. (kann u.U. die oben genannte E-Mail Adresse sein!)

$smtp['password'] = 'W%vk66i73'; // Das Passwort, mit welchem Sie sich bei Ihrem SMTP Server authentifizieren.
