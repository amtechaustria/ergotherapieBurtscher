...
if (isset($_POST["kf-km"]) && $_POST["kf-km"]) {
	...
	if(isset($anrede) && $anrede == "") {
		$fehler['anrede'] = "<span class='errormsg'>Bitte wählen Sie eine <strong>Anrede</strong> aus.</span>";
	}
   ...
   document.getElementsByTagName("BODY")[0].className += " safari";
			...
			?>
				...
				<div class="col-sm-8 <?php echo (isset($_POST['firma']) && ''!=$_POST['firma'] ? 'not-empty-field ' : ''); ?>">
					...
					<input aria-label="Firma" type="text" name="firma" class="field" placeholder="Firma" value="<?php echo $_POST['firma']; ?>" maxlength="<?php echo $zeichenlaenge_firma; ?>" id="border-right" onclick="setActive(this);" onfocus="setActive(this);"/>
				</div>
			</div>
		...
		<div class="row">
				<div class="col-sm-4 <?php if ($fehler["anrede"] != "") { echo 'error'; } ?> <?php echo (isset($_POST['anrede']) && ''!=$_POST['anrede'] ? 'not-empty-field ' : ''); ?>" >
					...
					<select  id="border-right2" <?php if($cfg['HTML5_FEHLERMELDUNGEN']) { ?> required style="box-shadow: 0 0 1px rgba(0,0,0, .4);" <?php } ?> aria-label="Anrede" name="anrede" class="field unselected" onchange="<?php if(!$cfg['HTML5_FEHLERMELDUNGEN']) { ?> checkField(this); <?php } ?>if(0!=this.selectedIndex){ this.setAttribute('class', 'field'); }else{ this.setAttribute('class', 'field unselected'); }" onclick="setActive(this);" onfocus="setActive(this);">
				...
				<div class="row">
				<div class="col-sm-4 <?php if ($fehler["vorname"] != "") { echo 'error'; } ?> <?php echo (isset($_POST['vorname']) && ''!=$_POST['vorname'] ? 'not-empty-field ' : ''); ?>">
					<label class="control-label" for="border-right4"><i id="user-icon" class="fa fa-user"></i></label>
					<input <?php if($cfg['HTML5_FEHLERMELDUNGEN']) { ?> required style="box-shadow: 0 0 1px rgba(0,0,0, .4);" <?php }else{ ?> onchange="checkField(this)" <?php } ?> aria-label="Vorname" type="text" name="vorname" class="field"  placeholder="Vorname *" value="<?php echo $_POST['vorname']; ?>" maxlength="<?php echo $zeichenlaenge_vorname; ?>" id="border-right4" onclick="setActive(this);" onfocus="setActive(this);"/>
				...
				<div class="col-sm-4 <?php if ($fehler["name"] != "") { echo 'error'; } ?> <?php echo (isset($_POST['name']) && ''!=$_POST['name'] ? 'not-empty-field ' : ''); ?>">
					...
					<input <?php if($cfg['HTML5_FEHLERMELDUNGEN']) { ?> required style="box-shadow: 0 0 1px rgba(0,0,0, .4);" <?php }else{ ?> onchange="checkField(this)" <?php } ?> type="text" name="name" class="field" placeholder="Nachname *" value="<?php echo $_POST['name']; ?>" maxlength="<?php echo $zeichenlaenge_name; ?>" id="border-right5" onclick="setActive(this);" onfocus="setActive(this);"/>
			...
			<div class="row">
				...
				<div class="col-sm-4 <?php echo (isset($_POST['telefon']) && ''!=$_POST['telefon'] ? 'not-empty-field ' : ''); ?>">
					...
					<input aria-label="Telefon" type="text" name="telefon" class="field" placeholder="Telefon/Mobil" value="<?php echo $_POST['telefon']; ?>" maxlength="<?php echo $zeichenlaenge_telefon; ?>" id="border-right7" onclick="setActive(this);" onfocus="setActive(this);"/>
				</div>
			</div>
		   ...
		   <div class="row">
			...
			<div class="row">
				<div class="col-sm-8 <?php if ($fehler["nachricht"] != "") { echo 'error'; } ?> <?php echo (isset($_POST['nachricht']) && ''!=$_POST['nachricht'] ? 'not-empty-field ' : ''); ?>">
					...
					<textarea <?php if($cfg['HTML5_FEHLERMELDUNGEN']) { ?> required <?php }else{ ?> onchange="checkField(this)" <?php } ?> aria-label="Nachricht" name="nachricht" class="field" rows="5" placeholder="Nachricht *" style="box-shadow: 0 0 1px rgba(0,0,0, .4);height:100%;width:100%;" id="border-right9" onclick="setActive(this);" onfocus="setActive(this);"><?php echo $_POST['nachricht']; ?></textarea>
